...
function fakeBattle(): BattleState {
  return {
    ...
    rivalStyle: "agresivo",
    rivalPower: 10,
    rivalArchetype: "agresivo",
    rivalFlow: 5,
    rivalPunchline: 7,
    rivalPersonality: { agresividad: 8, humor: 2, metrica: 3, frecuenciaDeRiesgo: 6 },
    crowdLoves: ["ataque"],
    crowdColds: ["defensa"],
    crowdLine: "La plaza pide sangre.",
    rivalEnergy: 90,
    rivalEnergyMax: 100,
    rivalHype: 40,
    rewardCash: 20,
    ...
    playerScore: 1,
    rivalScore: 0,
    prompt: { id: "tiempo", label: "Tiempo", text: "Tema", best: ["flow"] },
    hand: ["punchline", "flow", "humor", "ataque", "respuesta"],
    timeLeft: 12,
    results: [],
    pendingResult: null,
    finished: false,
