...
### Fase 6 — Tiempo, calendario y semana ✅ parcial (2026-08-12) — gauntlet 3 v2
...
- **Pendiente de esta fase:** eventos programados que **expiran** (oportunidades con fecha), descanso obligatorio por fatiga/salud mental, y la pregunta de diseño registrada en el GDD sobre si las batallas deben ser estrictamente de fin de semana.
