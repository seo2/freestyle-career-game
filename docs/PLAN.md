...
- **Tensión para decidir (owner):** el criterio de la Fase 7 ("al menos 3 dilemas antes de Plaza") choca con un ascenso rápido — un arco de 3 semanas tiene techo de 2 dilemas. Medido en cuatro semillas: arcos de 3-10 semanas, 2-4 dilemas. Subir la probabilidad **no** lo arregla (medido y revertido); es una pregunta de reja. Ver `docs/GDD.md`.
