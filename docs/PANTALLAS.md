...
| — | **Mapa: ciudad isométrica real (2026-08-13)** | el fondo ya no es una grilla procedural: es la ciudad del propio mockup, recortada y limpiada de su UI horneada (`scripts/build-map-city.mjs`). Los nodos, anillos, píldoras, candados, caminos y el MC los sigue dibujando el juego, y **cada coordenada de nodo se derivó del mockup**, no a ojo |
